      ...
      <main>
        ...
        <section className="bg-plaster-50">
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            ...
            />
            <div className="mt-6 max-w-prose space-y-4 text-base leading-relaxed text-plaster-700">
              <p>
        ...
        <section className="border-t border-warm bg-white">
          <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
            ...
            <div className="mt-8 grid gap-5 md:grid-cols-2">
              <article className="rounded-3xl border border-warm bg-plaster-50 p-7 shadow-plaster">
          ...
          <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-16 lg:px-8">
            {pdf ? (
              <a
                ...
                className="group inline-flex items-center gap-4 rounded-2xl border border-warm bg-plaster-50 p-5 shadow-plaster transition-transform hover:-translate-y-1"
              >
              ...
              <p className="text-sm text-plaster-500">
